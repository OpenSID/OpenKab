    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12 mb-4">
                            <a href="{{ route('data-pokok.data-presisi-adat.index') }}"
                                class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i
                                    class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Data Adat</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <h5><b>Rincian</b></h5>
            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped" id="detail-adat">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>NIK</th>
...
@section('js')
    <script nonce="{{ csp_nonce() }}">
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            var adat = $('#detail-adat').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ordering: true,
                ...
                ajax: {
                    ...
                    data: function(row) {
                        return {
                            ...
                            'include': 'anggota,rtm,penduduk,keluarga',
            ...
            adat.on('draw.dt', function() {
                var PageInfo = $('#detail-adat').DataTable().page.info();
                adat.column(0, {
                    page: 'current'
