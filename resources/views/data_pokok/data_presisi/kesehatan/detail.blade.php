                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12 mb-4">
                            <a href="{{ route('data-pokok.data-presisi.index') }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Data Kesehatan</a>
                        </div>
                    </div>
                    <div class="box-body">
...
@section('js')
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        kesehatan.on('draw.dt', function() {
            var PageInfo = $('#detail-kesehatan').DataTable().page.info();
            kesehatan.column(0, {
                page: 'current'
