    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12 mb-4">
                            <a href="{{ route('data-pokok.data-presisi-pendidikan.index') }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Data Pendidikan</a>
                        </div>
                    </div>
                    <div class="box-body">
            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped" id="detail-pendidikan">
                            <thead>
                                <tr>
                                    <th>NO</th>
                                    <th>NIK</th>
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        var pendidikan = $('#detail-pendidikan').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'attributes.pendidikan_dalam_kk',
                    orderable: false,
                },
                {
                    data: 'attributes.pendidikan_sedang_ditempuh',
                    orderable: false,
                },
                {
