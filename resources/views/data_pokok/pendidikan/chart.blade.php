<script nonce="{{ csp_nonce() }}"  >
    function grafikPie() {
        ...
        tampilChart('bar', 'barChart', generateChartData(data_grafik, 'ijazah_tertinggi'));

        // Data untuk pie chart
        tampilChart('doughnut', 'donutChart', generateChartData(data_grafik, 'partisipasi_sekolah'));
    }
