                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="card card-default">
                                ...
                                <div class="card-footer">
                                    {!! Form::button('<i class="fas fa-save"></i> Simpan', ['type' => 'button', 'class'
                                    => 'btn btn-primary btn-sm', 'id' => 'btnUpdate'] ) !!}
                                    {!! Form::button('<i class="fas fa-plus-square"></i> Tambah', ['type' => 'button',
                                    'class' => 'btn btn-success btn-sm', 'id' => 'btnAdd'] ) !!}
                                </div>
                                @endif
                            </div>
                        </div>
                        <div class="col-7">
                            <div class="card card-default">
                                ...
                                @if ($canwrite)
                                <div class="card-footer">
                                    {!! Form::button('<i class="fas fa-times"></i> Batal', ['type' => 'button', 'class'
                                    => 'btn btn-danger btn-sm reload'] ) !!}
                                    {!! Form::button('<i class="fas fa-save"></i> Simpan', ['type' => 'submit', 'class'
