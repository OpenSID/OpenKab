                            ...
                            <div x-data="{
                                ...
                                async retrievePosts() {
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <template x-if="key = 'warna_tema'">
                                        <x-adminlte-input-color name="color" x-bind:name="data.key" x-bind:data-color="data.value" x-model="data.value" data-color="" data-format='hex'
                                        ...
                                        <template x-if="key = 'warna_tema'">
                                            <x-adminlte-input name="data" x-bind:name="data.key" x-model="data.value">
                                            </x-adminlte-input>
                                        </template>
                                    </div>
                            </div>
