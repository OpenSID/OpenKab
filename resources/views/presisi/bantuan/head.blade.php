<div class="row">
    ...
    <div class="col-md-2">
        <button id="btn-tabel" class="btn btn-sm btn-info btn-block btn-sm " data-bs-toggle="collapse" href="#Tabel"
            role="button" aria-expanded="false" aria-controls="grafik-Tabel" disabled>
    ...
    <div class="col-md-2">
        <button id="btn-grafik" class="btn btn-sm btn-success btn-block btn-sm" data-bs-toggle="collapse"
            href="#grafik-statistik" role="button" aria-expanded="false" aria-controls="grafik-statistik" disabled>
