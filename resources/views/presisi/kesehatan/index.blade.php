                                    ...
                                    <table id="table-datas" class="table table-bordered table-striped table-responsive">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $data['JTRT'] }}
                                                </td>
                                                <td class="text-center" style="vertical-align: middle;">
                                                    {{ $data['ibu_hamil']['dataFilter'] == null ? '0' : sizeof($data['ibu_hamil']['dataFilter']) }}</td>
                                                <td class="text-center" style="vertical-align: middle;">{{ $data['jumlahKekRisti'] }}</td>
                                                <td class="text-center" style="vertical-align: middle;">
                                                    {{ $data['bulanan_anak']['dataFilter'] == null ? '0' : sizeof($data['bulanan_anak']['dataFilter']) }}
                                                </td>
                                                <td class="text-center" style="vertical-align: middle;">{{ $data['jumlahGiziBukanNormal'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1" class="text-center" style="vertical-align: middle;">{{ $data['tikar']['H'] }}
                                                </td>
                                                <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $data['tikar']['K'] }}
                                                </td>
                                                <td colspan="2" class="text-center" style="vertical-align: middle;">{{ $data['tikar']['M'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            @php
                                                $JLD_IbuHamil = $data['ibu_hamil']['tingkatKonvergensiDesa'] == null ? '0' : $data['ibu_hamil']['tingkatKonvergensiDesa']['jumlah_diterima'];
                                                $JLD_Anak = $data['bulanan_anak']['tingkatKonvergensiDesa'] == null ? '0' : $data['bulanan_anak']['tingkatKonvergensiDesa']['jumlah_diterima'];
                                                
                                                $JYSD_IbuHamil = $data['ibu_hamil']['tingkatKonvergensiDesa'] == null ? '0' : $data['ibu_hamil']['tingkatKonvergensiDesa']['jumlah_seharusnya'];
                                                $JYSD_Anak = $data['bulanan_anak']['tingkatKonvergensiDesa'] == null ? '0' : $data['bulanan_anak']['tingkatKonvergensiDesa']['jumlah_seharusnya'];
                                                
                                                $PERSEN_IbuHamil = $data['ibu_hamil']['tingkatKonvergensiDesa'] == null ? '0' : $data['ibu_hamil']['tingkatKonvergensiDesa']['persen'];
                                                $PERSEN_Anak = $data['bulanan_anak']['tingkatKonvergensiDesa'] == null ? '0' : $data['bulanan_anak']['tingkatKonvergensiDesa']['persen'];
