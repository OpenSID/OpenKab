...
<script nonce="{{ csp_nonce() }}">
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        var urlKategoriStatistik = new URL(`${baseUrl}/data-presisi/jaminan-sosial/kategori-statistik`);
        ...
        var urlStatistik = new URL(`${baseUrl}/data-presisi/jaminan-sosial/statistik`);
        ...
        var statistik = tabelData.DataTable({
            processing: true,
            serverSide: true,
            autoWidth: false,
            ordering: true,
