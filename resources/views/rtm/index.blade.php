    ...
    <script nonce="{{ csp_nonce() }}">
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            var keluarga = $('#keluarga').DataTable({
                ...
                ordering: true,
                ajax: {
                    url: `{{ config('app.databaseGabunganUrl') . '/api/v1/rtm' }}`,
                    headers: header,
                    method: 'get',
                    data: function(row) {
                        return {
                ...
                columns: [{
                    ...
                    },
                    {
                        data: function(data) {
                            if (data.attributes.no_kk) {
                                return `<a title="Lihat Detail Biodata RTM" href="rtm/detail/${data.attributes.no_kk}">${data.attributes.no_kk}</a>`
                            } else {
                                return null
                            }
                        },
                    ...
                    {
                        data: function(data) {
                            return `<a title="Lihat Detail Biodata Penduduk" href="penduduk/${data.attributes.nik_kepala}">${data.attributes.nik}</a>`
                        },
                        name: "nik"
                    },
                    {
