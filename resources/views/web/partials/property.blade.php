    ...
    <div class="row g-0 gx-5 align-items-end">
        <div class="col-lg-6">
            <div class="text-start mx-auto mb-5 wow slideInUp" data-wow-delay="0.1s">
                <h1 class="mb-3">{{ config('app.sebutanDesa') }} Paling Aktif
                </h1>
                <p>{{ config('app.sebutanDesa') }} yang sudah mengisi data &
                    pengujung terbanyak</p>
            </div>
        </div>
    </div>
                ...
                @for ($i = 0; $i < 6; $i++)
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="kelurahan-item rounded overflow-hidden">
                            ...
                            <div class="p-4 pb-0">
                                <a class="d-block h5 mb-2 nama-desa-elm" href="">Nama
                                    {{ config('app.sebutanDesa') }}</a> <a class="website-elm" href="#"><i
                            ...
                            <div class="d-flex border-top">
                                ...
                                <small class="flex-fill text-center py-2 rtm-elm"><i
                                        class="fa fa-home text-primary me-2"></i>0
                                    RTM</small>
                            </div>
                        </div>
                    </div>
                ...
                if (result.data.length > 0) {
                    ...
                    result.data.forEach((item, index) => {
                        ...
                        _elm.find('.penduduk-elm').html(
                            ...
                            .penduduk + ' Penduduk')
                        _elm.find('.alamat-elm').html(
                            '<i class="fa fa-map-marker-alt text-primary me-2"></i>' + (item
                                .attributes.alamat ?? 'alamat belum ditentukan'))
