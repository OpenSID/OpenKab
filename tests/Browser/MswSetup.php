...
final class MswSetup
{
    ...
    private const ROUTES = [
        ...
        '/api/v1/data-presisi/pangan' => 'pangan.json',
        '/api/v1/data-presisi/sandang' => 'sandang.json',
        '/api/v1/data-presisi/papan' => 'papan.json',
        '/api/v1/data-presisi/seni-budaya' => 'seni-budaya.json',
        '/api/v1/data-presisi/adat' => 'adat.json',
        '/api/v1/agama' => 'agama.json',
    ];
