...
it('opens the statistik jaminan sosial page', function () use ($path) {
    $page = SessionState::loginAndNavigate($this->user, $path)
        ->assertPathIs($path)
        ->assertSee('Jaminan Sosial');

    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-page');
});
...
it('displays kategori statistik list', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-kategori-list');
});
...
it('displays filter tahun', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-filter-tahun');
});
...
it('displays excel button', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-excel-button');
});
...
it('displays grafik button', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-grafik-button');
});
...
it('displays chart button', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-chart-button');
});
...
it('displays datatable', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-datatable');
});
...
it('datatable displays data', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-datatable-data');
});
...
it('renders bar chart', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-bar-chart');
});
...
it('renders pie chart', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-pie-chart');
});
...
it('has no javascript errors', function () use ($path) {
    ...
    ScreenshotHelper::saveIfEnabled($page, 'statistik-jaminan-sosial-no-errors');
});
